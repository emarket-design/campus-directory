...
function emd_lite_get_operations($type,$plural_label,$textdomain){
	...
	elseif($type == 'cust_fields'){
		...
		<div class="emd-oper-modal-button">
			<a href="' . esc_url("https://emdplugins.com/plugin-pricing/campus-directory-wordpress-plugin-pricing/?pk_campaign=" . $app . "-cust-fields&pk_kwd=upgradelink") . '" class="emdmodalbtn" target="_blank" rel="noopener noreferrer">';
