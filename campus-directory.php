...
if (!class_exists('Campus_Directory')):
	...
	final class Campus_Directory {
		...
		private function define_constants() {
			define('CAMPUS_DIRECTORY_VERSION', '1.7.3');
		...
		public function display_settings() {
			...
			add_menu_page(__('CampusDirectory', $this->textdomain) , __('CampusDirectory', $this->textdomain) , $settings_pages_cap, $this->app_name, array(
				$this,
